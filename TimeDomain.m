...
% Parameters
z = 400; % Number of points in the z direction
time = 250; % Number of time steps
zs = 200; % Position of the source in the domain
c = 3e8; % Speed of light (m/s)
Cs = 1; % Courant stability factor
dz = 1e-5; % Spatial step length (m)
dt = Cs * dz / c; % Time step (s)
f = 1e12; % Frequency of the source (Hz)
